...
**主题：** 三年来的最大更新、扩展假设、RL 扩展、AGI 时间线、经济扩散、算力投资、监管、中国与出口管制、宪法 AI、公司文化
...
**Dwarkesh Patel：** 我们三年前聊过。我很好奇，在你看来，过去三年最大的更新是什么？过去三年与现在相比，最大的不同是什么？

**Dario Amodei：** 实际上，底层技术、技术的指数发展，大致如我所预期。这里有一两年的误差，那里有一两年的误差。我不确定我会预测代码的具体方向，但当我看指数时，模型从聪明高中生到聪明大学生到开始做博士和专业工作、在代码方面超越的进程，大致符合我的预期。所以前沿有点 uneven，但大致如我所料。不过我要告诉你最令人惊讶的事。最令人惊讶的是公众对我们将接近指数尾声缺乏认识。对我来说，在泡沫内外，人们都在谈论同样老套的热门政治议题，而我们正接近指数的尾声，这绝对令人震惊。

### 当前扩展假设

**Dwarkesh Patel：** 我想理解当前指数是什么样子。三年前有这些众所周知的公开趋势，在许多数量级的算力上你可以看到损失如何改善。现在我们有了 RL 扩展，没有公开已知的扩展定律。当前的扩展假设是什么？

**Dario Amodei：** 我实际上和 2017 年甚至更早时的假设一样。2017 年我写了一份叫「大算力 blob 假设」的文档。我具体说的是：只有少数东西重要，我列出了七个——原始算力、数据量、数据质量与分布、训练时长、可无限扩展的目标函数、归一化与 conditioning。预训练扩展定律是我们在那里看到的一个例子，它们确实在继续。改变的是我们现在也看到 RL 的同样情况。所以我们看到预训练阶段，然后在其上看到 RL 阶段。RL 实际上完全一样。其他公司也在发布中说过，模型在数学竞赛上的表现与训练时长呈对数线性，我们也看到这个。所以我们看到 RL 中与预训练相同的扩展。

### AGI 时间线

**Dario Amodei：** 在「十年内我们会得到我所说的数据中心里的天才国度」这一基本假设上，我 90% 确信。对于可验证的任务如编程，除不可约的不确定性外，我认为一两年内我们会达到端到端编程。对于不可验证的任务如规划火星任务、做基础科学发现、写小说，我几乎确定我们有可靠路径到达，但若有一点不确定性，就在那里。所以十年内我 90%，那大约是你能确定的极限。说 2035 年前这不会发生是疯狂的，在 sane 的世界里那会是主流之外。

### 经济扩散与算力投资

**Dario Amodei：** 我们看到了从 2023 年 0 到 1 亿美元、2024 年 1 亿到 10 亿、2025 年 10 亿到 90 或 100 亿的 bizarre 10 倍年收入增长。今年一月我们又增加了几十亿收入。那是一条快曲线。当谈到买数据中心时，如果我们假设收入继续每年 10 倍增长，2026 年底会是 1000 亿，2027 年底会是 1 万亿。我可以买 2027 年底开始的 1 万亿算力。但如果我的收入不是 1 万亿，即使是 8000 亿，如果买了那么多算力，地球上没有任何力量、任何对冲能阻止我破产。所以即使我脑子有一部分想知道是否会继续 10 倍，如果增长率是每年 5 倍而非 10 倍，我就破产了，我不能买 2027 年每年 1 万亿的算力。所以我们支持的是数千亿而非万亿，接受需求太大无法支持收入的风险，也接受我们搞错了仍然缓慢的风险。

### 中国与出口管制

**Dwarkesh Patel：** 为什么美国和中国不能都有数据中心里的天才国度？

**Dario Amodei：** 如果我们有进攻主导的情况，我们可能有一种比核武器更危险的情况，任一方都能轻易摧毁一切。我们也可能有一个不稳定的世界。核均衡是稳定的，因为威慑。但假设两个 AI 交战哪个会赢存在不确定性——那可能造成不稳定。另一个担忧是政府会用 AI 压迫自己的人民。我担心世界被分成两块，其中一块可能是极权主义，难以推翻。我希望当规则制定时，民主国家、政府更接近亲人类价值观的国家持有更强的牌，在设定规则时有更多筹码。

### 宪法 AI 与公司文化

**Dario Amodei：** 关于宪法，我们教模型原则、让它从原则学习，其行为更一致、更容易覆盖边缘情况、更可能做人们想让它做的事。如果给它规则列表，它不太理解规则，难以泛化。如果给它原则再加硬护栏如不要制造生物武器，总体上你试图理解它应该瞄准什么、应该如何运作，从实践角度那是更有效的训练方式。关于公司文化，我可能花三分之一也许 40% 的时间确保 Anthropic 的文化良好。我每两周站在全公司面前讲一小时。我有一份三四页的文档，我坦诚地讲三四个不同主题——内部进展、我们生产的模型、产品、外部行业、与 AI 和地缘政治相关的世界。然后回答问题。那种直接联系在你要把东西传下去六级时很难实现。
...
And it’s not just math contests, it’s a wide variety of RL tasks. And so we’re seeing the same scaling in RL that we saw for pre-training.
